...
import { LoginAction, SignUpAction } from '../../store/actions/app.actions';
import { LoginConstants } from '../../constants/app-constants';
import { CommonError, FormModel } from 'src/app/shared/models';
import { selectLoginError, selectUser } from '../../store/reducers';
...
export class LoginComponent implements OnInit, OnDestroy {
  constructor(private store: Store<RootState>, private fb: FormBuilder, private router: Router) {
